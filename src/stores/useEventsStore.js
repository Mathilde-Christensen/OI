...
// OBS: Mathilde laver login – når I har en bruger, kalder I bindUser(uid)
// indtil da virker oversigten stadig (uden "booket af mig"-markering)
...
export const useEventsStore = defineStore('events', () => {
  ...
  // Tilmeld/frameld (transaction så vi ikke oversælger)
